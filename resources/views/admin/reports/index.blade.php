        ...
        <div class="col-md-4">
            <div class="card bg-info text-dark shadow-sm border-0 rounded-4">
                <div class="card-body text-center p-4">
                    ...
                    <p class="mb-0 text-dark-50">Total COVID Tests</p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card bg-danger text-dark shadow-sm border-0 rounded-4">
                <div class="card-body text-center p-4">
                    <h3 class="display-4 fw-bold mb-0">{{ $positiveCount ?? 0 }}</h3>
                    <p class="mb-0 text-dark-50">Positive Cases</p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card bg-teal text-dark shadow-sm border-0 rounded-4" style="background-color: #20c997;">
                <div class="card-body text-center p-4">
                    <h3 class="display-4 fw-bold mb-0">{{ $vaccinationCount ?? 0 }}</h3>
                    <p class="mb-0 text-dark-50">Vaccinations Given</p>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($appointment->testResult)
                                            <span
                                                class="badge @if($appointment->testResult->result == 'positive') bg-danger @elseif($appointment->testResult->result == 'negative') bg-success @else bg-warning @endif rounded-pill px-3">
